...
animateMotion_ :: [Attribute action] -> View action
...
animateTransform_ :: [Attribute action] -> View action
...
feColorMatrix_ :: [Attribute action] -> View action
...
feComposite_ :: [Attribute action] -> View action
...
feConvolveMatrix_ :: [Attribute action] -> View action
...
feDisplacementMap_ :: [Attribute action] -> View action
...
feGaussianBlur_ :: [Attribute action] -> View action
...
feImage_ :: [Attribute action] -> View action
...
feMergeNode_ :: [Attribute action] -> View action
...
--
-- @since 1.9.0.0
feMorphology_ :: [Attribute action] -> View action
...
feOffset_ :: [Attribute action] -> View action
...
fePointLight_ :: [Attribute action] -> View action
...
feSpotLight_ :: [Attribute action] -> View action
...
view_ :: [Attribute action] -> View action
